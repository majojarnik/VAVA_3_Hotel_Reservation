...
import sk.stu.fiit.controller.ServiceController;
...
public class AddService extends javax.swing.JFrame {
    ...
    public AddService(MainWindow main) {
        this.main = main;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pridanie služby");
    ...
    private void btnSaveMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseReleased
        ...
        try {
            con.addService(txfName.getText(), txaDesc.getText(), txfPrice.getText());
            main.initTableServices();
            dispose();
